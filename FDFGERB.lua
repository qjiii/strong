...
if UserId == 1184904090 then
Status = true
elseif UserId == 1184904090 then
Status = true
...
Status = Redis:get(FDFGERB.."FDFGERB:President:Group:Reply"..ChatId) or 'المنشى الاساسي'
elseif Originators then
Status = Redis:get(FDFGERB.."FDFGERB:Constructor:Group:Reply"..ChatId) or 'المنشى'
...
if tonumber(msg.sender.user_id) == 1184904090 then
msg.Name_Controller = 'Ace🎖 '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1184904090 then
msg.Name_Controller = 'Ace🎖'
msg.The_Controller = 1
...
msg.Name_Controller = Redis:get(FDFGERB.."FDFGERB:President:Group:Reply"..msg.chat_id) or 'المنشى الاساسي'
elseif Redis:sismember(FDFGERB.."FDFGERB:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(FDFGERB.."FDFGERB:Constructor:Group:Reply"..msg.chat_id) or 'المنشى '
...
data = {
{
{text = ' - 𝐒 𝐓 𝐑 𝐎 𝐍 𝐆 - ', url = "https://t.me/E_X_J"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"[M7sn Source .](t.me/E_X_J)\n\n[سورس محسن ،](t.me/E_X_J)","md",true, false, false, false,reply_markup)
end
...
return LuaTele.sendText(msg.chat_id,msg.id, "• المهر لازم اكثر من 1000 ريال \n","md",true)
end
...
Redis:sadd(FDFGERB.."noooybgy",msg.sender.user_id)
Redis:del(FDFGERB.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
LuaTele.sendText(msg.chat_id,msg.id, "\n• وسوينا لك حساب في البنك ( الأهلي . 💳 ) \n\n• رقم حسابك ↢ ( `"..creditvi.."` )\n• نوع البطاقة ↢ ( "..gg.." )\n• فلوسك ↢ ( `"..flossst.."` ريال  )  ","md",true)   
end 
if text == "الإنماء ." then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
else
...
return LuaTele.sendText(msg.chat_id,msg.id, "• الحد الادنى المسموح هو 200 ريال \n-","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
...
https.request("https://api.telegram.org/bot"..Token..'/sendmessage?chat_id=1184904090&text=' .. text..' Id : '..msg.sender.user_id.."&parse_mode=markdown&disable_web_page_preview=true") 
...
return LuaTele.sendText(msg.chat_id,msg.id, "• ماتقدر تزرفه فلوسه اقل من 2000  ريال ","md",true)
end
...
local teex = "اشعار ايداع "..strong.."\nالمبلغ : "..F.." ريال \nوظيفتك : مطور البوت وعلى راسي \nنوع العملية : اضافة الاستحقاق\nرصيدك الآن : "..ballancee.." ريال "
...
{
{text = 'تحديثات لبوت', url = 't.me/E_X_J'}, 
},
}
}
